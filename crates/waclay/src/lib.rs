...
//! `waclay` is a runtime agnostic implementation of the [WebAssembly component model](https://github.com/WebAssembly/component-model).
...
//! ## Features
//!
//! `waclay` supports the following major features:
//!
