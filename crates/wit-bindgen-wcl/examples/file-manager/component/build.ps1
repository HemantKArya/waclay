...
Write-Host "Building file-manager component..." -ForegroundColor Cyan
...
wasm-tools component new target/wasm32-unknown-unknown/release/file_manager_component.wasm -o component.wasm
